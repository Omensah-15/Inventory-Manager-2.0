...
def render_dashboard():
    ...
    with col2:
        ...
        <div class='metric-card'>
            ...
            <div class='metric-value'>{metrics.get('stock_value', f"{st.session_state.currency} 00.00")}</div>
    ...
    with col4:
        ...
        <div class='metric-card'>
            ...
            <div class='metric-value'>{metrics.get('monthly_sales', f"{st.session_state.currency} 00.00")}</div>
